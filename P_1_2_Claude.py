...
class MazeSolver(Node):
    ...
    def control_loop(self):
        ...
        # --- LÓGICA DE DETECCIÓN DE CALLEJÓN (MUY SIMPLE) ---
        # Si está bloqueado por todos lados, vamos a retroceder.
        if self.estado == 'avanzar' and self.d_front < 0.25 and self.d_left < 0.35 and self.d_right < 0.35:
